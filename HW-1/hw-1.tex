...
\begin{solution}
  ...
  \[
    z = (-2 + 2\sqrt{3}) + i(2 + 2\sqrt{3})
  \]
  Then taking the inverse tangent:
  \[
    \theta = \arctan\left(\frac{2+2\sqrt{3}}{-2+2\sqrt{3}}\right) = \frac{1}{12}\pi \quad \text{which is already in the 1st quadrant}
  \]
  ...
  Finally:
  \[
    z = 4\sqrt{2}\left(\cos\left(\frac{1}{12}\pi\right) + i\sin\left(\frac{1}{12}\pi\right)\right)
  \]
\end{solution}
